    ...
    */
            ...
            while ((goingToTheRight && stepsToCurrent <= current) || (!goingToTheRight && stepsToCurrent >= current) || (force && stepsToCurrent == current)) {
                ...
                while (i--) {
                    ...
                    if (i < stepsToCurrent) {
                        ...
                        if (document.getElementsByName('chek').length > 0) {
                            document.getElementsByName('chek').item(i).style.visibility = 'hidden';
                        }
                        ...
                        if (document.getElementsByName('chek').length > 0) {
                            document.getElementsByName('chek').item(i).style.visibility = 'visible';
                        }
                    }
    ...
    $.ui.jcoverflip.defaults = {
        ...
        beforeCss: function (el, container, offset) {
            ...
            return [
			$.jcoverflip.animationElement(el, { left: (container.width() / 2 - 210 - 150 * offset) + 'px', bottom: '20px' }, {}),
			$.jcoverflip.animationElement(el.find('img'), { opacity: 0.5, width: Math.max(10, 100 - 20 * offset * offset) + 'px' }, {})
        ...
        afterCss: function (el, container, offset) {
            return [
			$.jcoverflip.animationElement(el, { left: (container.width() / 2 + 110 + 150 * offset) + 'px', bottom: '20px' }, {}),
			$.jcoverflip.animationElement(el.find('img'), { opacity: 0.5, width: Math.max(10, 100 - 20 * offset * offset) + 'px' }, {})
